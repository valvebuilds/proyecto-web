...
exports.createUser = async (nombre, email, password,
                            rol_id, admin_id) => {
                                try{
                                    ...
                                    if (!adminUser) {
                                        throw new Error(`El usuario con el ID ${admin_id} no existe o no es un administrador válido.`);
                                    }
