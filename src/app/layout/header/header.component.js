...
var feather_icons_component_1 = require("@shared/components/feather-icons/feather-icons.component");
...
var HeaderComponent = function () {
    ...
    var HeaderComponent = _classThis = /** @class */ (function () {
        function HeaderComponent_1(document, renderer, elementRef, configService, 
        ...
        HeaderComponent_1.prototype.callFullscreen = function () {
            var _a, _b;
            if (!this.isFullScreen) {
                if (((_a = this.docElement) === null || _a === void 0 ? void 0 : _a.requestFullscreen) != null) {
                    (_b = this.docElement) === null || _b === void 0 ? void 0 : _b.requestFullscreen();
                }
            }
            else {
        ...
        HeaderComponent_1.prototype.mobileMenuSidebarOpen = function (event, className) {
        ...
        HeaderComponent_1.prototype.callSidemenuCollapse = function () {
